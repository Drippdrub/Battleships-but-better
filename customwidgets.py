...
class Image():
	...
	def __init__(self, x, y, image, scale, tiptext=""):
		...
		self.buttonf = pygame.font.SysFont(resource_path("resources\\fonts\CompassPro.ttf"), 18)
...
class Toggle():
	def __init__(self, x, y, image_off, image_on, scale, blip):
	...
	def changeBlip(self, volume):
		self.blip.set_volume(volume)
